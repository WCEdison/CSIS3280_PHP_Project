...
// Finish the __contstruct function. Notice that 
// the intant of the PDO driver is private $pdo
...
class PDOService  {
    ...
    private $pdo = null;          //Store our local instantiation of the PDO driver
    ...
    public function __construct(string $className)  {
        ...
        // try catch to connect to the db
        try {
